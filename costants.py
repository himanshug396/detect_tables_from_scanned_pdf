...
inference_graph_adam_3 = \
    os.path.join('./inference_graph_example/frozen_inference_graph.pb')
...
TEST_PDF_PATH = os.path.join('/home/himanshu/Videos/images/img_pdf/8.pdf')
TEST_TABLE_PATH = os.path.join('table/4/table_pag_0_0.jpeg')
